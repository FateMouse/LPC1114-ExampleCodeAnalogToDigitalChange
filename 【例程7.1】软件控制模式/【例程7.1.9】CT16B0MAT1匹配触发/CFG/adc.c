...
void TIM16B0_MAT1_Init(uint16_t cycle_ms)
{
	...
	LPC_TMR16B0->MR1 = cycle_ms;//
	LPC_TMR16B0->IR  = 0x02;		  //MR1中断复位（bit0:MR0, bit1:MR1, bit2:MR2, bit3:MR3, bit4:CP0）
	LPC_TMR16B0->MCR = 0x10;		  //MR1中断产生时复位TC
	LPC_TMR16B0->EMR |= (0x3<<6);		  //MR1与PC相等时，MAT1引脚翻转电平
